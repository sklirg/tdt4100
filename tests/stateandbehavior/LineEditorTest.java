...
public class LineEditorTest extends TestCase {
	...
	public void testInsertString() {
		...
		lineEditor.insertString(" er goy!");
		testLineEditor("Java er goy!",  12);

		setLineEditor("Javagoy!", 4);
		lineEditor.insertString(" er ");
		testLineEditor("Java er goy!",  8);
		
		setLineEditor("er goy!", 0);
		lineEditor.insertString("Java ");
		testLineEditor("Java er goy!",  5);
	}
